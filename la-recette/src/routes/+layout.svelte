...
<header>
    ...
    <nav class="desktop-nav">
        <a href="/events" class:active={isActive('/events')} aria-current={isActive('/events') ? 'page' : undefined}>Événements</a>
        ...
        <a href="/cart" aria-label="Panier" class="cart-link" class:active={isActive('/cart')} aria-current={isActive('/cart') ? 'page' : undefined}>
