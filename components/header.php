<header>
    <span>
        <a href="/"><img src="../styles/images/larecette.webp" height="90" width="90" alt="LaRecette" decoding="async"></a>
        <a href="account"><svg width="50" height="90" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="var(--primary)">
