...
<body>
    ...
    <main>
        ...
        <div class="page-content">
            <div class="minis">
                <div>
                    <img src="/assets/images/petitfour.webp" alt="Mini Hotdog" width="300px" height="300px">
                    <h3>Mini Hot-dog</h3>
                    <p>Saucisse, cornichon, moutarde, ketchup, oignon frit</p>
                </div>
                <div>
                    <img src="/assets/images/mini-burger.webp" alt="Mini Burger" width="300px" height="300px">
                    <h3>Mini Burger</h3>
                    <p>Steak haché, fromage, laitue, ketchup, sauce burger, cornichon, tomate</p>
                </div>
                <div>
                    <img src="/assets/images/mini-kebab.webp" alt="Mini Kebab" width="300px" height="300px">
                    <h3>Mini Kebab</h3>
                    <p>Poulet, tomate, salade, sauce blanche, pain maison.</p>
                </div>
                <div>
                    <img src="/assets/images/navette-fraicheur.webp" alt="Navette Fraicheur" width="300px" height="300px">
