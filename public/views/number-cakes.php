    ...
    <main>
        ...
        <div class="page-content">
            <div class="aboutnumbercakes">
                <img src="/assets/images/numberCakeE.webp" width="200px" height="auto">
                <span>
                    <h2>Number cake disponible :</h2>
                    <ul>
                        <li>Façon framboisier, poirier ou pêcher ( génoise , crème mousseline, fruits )</li>
                        <li>Façon moelleux chocolat/ganache chocolat au lait.</li>
                        <li>Façon macaron : ( Chocolat au lait/praliné feuilletine ou Chocolat blanc/compotée de framboise )</li>
                    </ul>
                </span>
            </div>
        </div>
